...
export default function TrainerDescription() {
  ...
  <h2 className='text-white text-md font-semibold text-2xl'>Get to know Ahmed</h2>
  <p className="max-w-5xl py-6">Norem ipsum dolor sit amet, consectetur adipiscing elit. 
