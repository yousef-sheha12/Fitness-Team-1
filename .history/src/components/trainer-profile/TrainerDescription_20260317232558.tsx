...
export default function TrainerDescription() {
  ...
  <h2 className='text-white font-semibold text-3xl'>Get to know Ahmed</h2>
  <p className="max-w-5xl py-6 mx-auto text-gray-400">Norem ipsum dolor sit amet, consectetur adipiscing elit. 
