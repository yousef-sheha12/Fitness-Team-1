...
export default function TrainerCertifictions() {
 ...
 <Card className="group relative mx-auto w-full max-w-sm overflow-hidden rounded-2xl bg-zinc-900 border border-zinc-800 hover:border-red-500 transition duration-300">
