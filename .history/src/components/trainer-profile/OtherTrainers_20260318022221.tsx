...
<TrainerCard image= name="Kareem Moustafa" rating= {4.5} price={180}  specialties={["body Transformation","general Fitness","Functional Training"]}  location="cairo"></TrainerCard>
      </div>
      </div>
    </>
