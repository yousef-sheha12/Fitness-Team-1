...
<ul className="flex gap-4 flex-wrap">
    ...
    <li className=" hover:bg-p transition-colors duration-300 px-8 py-2 before:mx-3 bg-black text-white rounded-md relative before:absolute before:top-1/2 before:-translate-y-1/2 before:left-0 before:rounded-full before:content-[''] before:w-3 before:h-3 before:bg-red-500 font-light">Muscle Gain Coach</li>
