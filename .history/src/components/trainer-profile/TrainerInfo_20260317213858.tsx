import { FaLocationCrosshairs, FaLocationDot, FaStar } from "react-icons/fa6";
...
<ul className="space-y-4">
    <li className="flex gap-3"> 
        <span><FaCheck className="bg-green-500 w-6 p-1 h-6 rounded-full"/></span>
        <p>Available This Week </p>
    </li>
    <li className="flex gap-3"> 
        <span><FaStar className="bg-green-500 w-6 p-1 h-6 text-red-600  rounded-full"/></span>
        <p>Available This Week </p>
    </li>
    <li className="flex gap-3"> 
        <span><FaLocationDot className=" w-6 p-1 h-6 text-red-600 rounded-full"/></span>
        <p>Nasr City , Egypt </p>
    </li>
</ul>
</div>
