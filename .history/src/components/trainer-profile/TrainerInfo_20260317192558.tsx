...
<h3>Ahmed Mohamed </h3>
<ul>
    <li className="px-2 py-1 bg-black text-white rounded-md relative before:absolute top before:content-[''] before:w-1 before:h-1 before:bg-red-500 ">Weight Loss Coach</li>
</ul>
</div>
        </div>
    </>
