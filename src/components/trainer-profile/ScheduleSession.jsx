...
export default function ScheduleSession({ trainerId }) {
  ...
  const handleBooking = () => {
    navigate(`/booking?trainerId=${trainerId}&date=${date?.toISOString()}&time=${selectedTime}`);
  };

  return (
    <>
      <div className="container w-10/12 mx-auto">
        <h2 className="profile-heading w-fit mx-auto">Schedule your session</h2>
