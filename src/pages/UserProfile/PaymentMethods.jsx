...
import { getCards } from "@/lib/api/payment.api";
  ...
  return (
    <div className="flex flex-col gap-6 px-4 sm:px-10">
      ...
      <div className="flex flex-col sm:flex-row gap-5">
        ...
        {isLoading && <div className="flex-1 text-white">Loading cards...</div>}
        ...
        {fetchedCards &&
          fetchedCards.map((card) => (
            <div
              key={card.id}
              className="flex-1 relative bg-gradient-to-br from-[#1a3a6b] via-[#0f2348] to-[#0a1628] rounded-3xl p-7 flex flex-col justify-between min-h-[220px] shadow-2xl overflow-hidden"
            >
        ...
        {!isLoading && (!fetchedCards || fetchedCards.length === 0) && (
