      ...
      <div className="border border-(--gray-color) rounded-2xl overflow-hidden">
        ...
        >
          ...
          <button 
            ...
            className="w-full max-w-lg h-13 text-base font-semibold text-white bg-primary rounded-xl hover:bg-primary/90 hover:-translate-y-0.5 shadow-lg shadow-primary/25 transition-all duration-200 cursor-pointer disabled:opacity-50"
          >
